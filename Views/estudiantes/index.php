	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-hover media-middle">
					<thead>
						<tr>
							<th>Imagen</th>
							<th>Nombre</th>
					...
					<tbody>
						...
						<tr>
							<td>							
								<img class="imagen-avatar img-circle img-responsive" src="<?php echo URL; ?>Views/template/imagenes/avatars/<?php echo $row['imagen']; ?>">
							</td>
							<td>
								<a href="<?php echo URL; ?>estudiantes/ver/<?php echo $row['id']; ?>"><?php echo $row['nombre']; ?>
								</a>
							</td>
